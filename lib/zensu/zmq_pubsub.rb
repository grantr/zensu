module Zensu
  ...
  module ZMQPubsub
    ...
    # can do this without zmq if we require a broker
    #
    # broker pushes messages directly to mailboxes of notifiers
    # notifiers push messages directly to mailbox of broker
    # notifiers do a selective receive
    class Broker
